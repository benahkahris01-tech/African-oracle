...
// ── Boot — only runs on the screener page (index.html) ───────
// stock.html also loads app.js for the API_URL variable,
// but must NOT run bindFilters/fetchData since those elements
// don't exist on stock.html — doing so throws errors that
// silently kill all subsequent JS including stock.js
document.addEventListener("DOMContentLoaded", function () {
  // Check we are actually on the screener page before running
